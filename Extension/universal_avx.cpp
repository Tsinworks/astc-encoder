...
#define compute_averages_and_variances compute_averages_and_variances_avx2
#define compute_symbolic_block_difference compute_symbolic_block_difference_avx2
#define expand_deblock_weights expand_deblock_weights_avx2
#define fetch_image_block fetch_image_block_avx2
#define write_image_block write_image_block_avx2
#define init_compute_averages_and_variances init_compute_averages_and_variances_avx2
#define term_block_size_descriptor term_block_size_descriptor_avx2
